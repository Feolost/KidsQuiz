...
public class okr_8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_okr8);
        ...
        final MediaPlayer dictor = MediaPlayer.create(this,R.raw.okr8);
        ...
        question_4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(okr_8.this, okr_9.class);
