...
public class math_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer dictor = MediaPlayer.create(this,R.raw.math4);
        ...
        question_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(math_4.this, math_5.class);
