...
public class okr_10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_okr10);
        Window w = getWindow();
        ...
        final MediaPlayer dictor = MediaPlayer.create(this,R.raw.okr10);
        ...
        question_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(okr_10.this, congratulation.class);
