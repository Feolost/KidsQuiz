...
public class math_10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer dictor = MediaPlayer.create(this,R.raw.math10);
        ...
        question_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(math_10.this, congratulation1.class);
