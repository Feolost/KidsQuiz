...
public class math_9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer dictor = MediaPlayer.create(this,R.raw.math9);
        ...
        question_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(math_9.this, math_10.class);
