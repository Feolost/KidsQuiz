...
public class okr_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_okr7);
        Window w = getWindow();
        ...
        final MediaPlayer dictor = MediaPlayer.create(this,R.raw.okr7);
        ...
        question_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(okr_7.this, okr_8.class);
