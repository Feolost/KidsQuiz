...
public class rus_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus4);
        ...
        final MediaPlayer dictor = MediaPlayer.create(this,R.raw.rus4);
        ...
        question_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(rus_4.this, rus_5.class);
