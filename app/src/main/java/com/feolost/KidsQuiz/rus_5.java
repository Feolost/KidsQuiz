...
public class rus_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus5);
        ...
        final MediaPlayer dictor = MediaPlayer.create(this,R.raw.rus5);
        ...
        question_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(rus_5.this, congratulation2.class);
