...
public class rus_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus3);
        ...
        final MediaPlayer dictor = MediaPlayer.create(this,R.raw.rus3);
        ...
        question_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(rus_3.this, rus_4.class);
