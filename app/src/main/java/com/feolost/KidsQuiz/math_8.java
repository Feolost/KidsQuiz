...
public class math_8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer dictor = MediaPlayer.create(this,R.raw.math8);
        ...
        question_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(math_8.this, math_9.class);
